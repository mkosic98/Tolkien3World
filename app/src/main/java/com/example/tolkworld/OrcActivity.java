...
public class OrcActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycler=findViewById(R.id.rvOrcRecycler);
        ...
        db.collection("Orcs")
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        adapter=new OrcRecyclerAdapter(OrcActivity.this,modelList);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(OrcActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
